...
static irop_t irops[] = {
  ...
  { DEFOP(Iop_ClzNat64,   UNDEF_ALL),  .s390x = 1, .amd64 = 1, .x86 = 0, .arm = 0, .ppc64 = 1, .ppc32 = 0, .mips32 =0, .mips64 = 1, .loongarch64 = 0 }, // ppc32 asserts
  { DEFOP(Iop_ClzNat32,   UNDEF_ALL),  .s390x = 0, .amd64 = 0, .x86 = 1, .arm = 1, .ppc64 = 1, .ppc32 = 1, .mips32 =1, .mips64 = 1, .loongarch64 = 0 },
  { DEFOP(Iop_CtzNat64,   UNDEF_ALL),  .s390x = 0, .amd64 = 1, .x86 = 0, .arm = 0, .ppc64 = 1, .ppc32 = 0, .mips32 =0, .mips64 = 0, .loongarch64 = 0 },
  { DEFOP(Iop_CtzNat32,   UNDEF_ALL),  .s390x = 0, .amd64 = 0, .x86 = 1, .arm = 0, .ppc64 = 0, .ppc32 = 1, .mips32 =0, .mips64 = 0, .loongarch64 = 0 },
  ...
  { DEFOP(Iop_MullEven64Ux2, UNDEF_UNKNOWN) },
  ...
  { DEFOP(Iop_MullEven64Sx2, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd8Ux16, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd16Ux8, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd32Ux4, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd64Ux2, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd8Sx16, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd16Sx8, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd32Sx4, UNDEF_UNKNOWN) },
  { DEFOP(Iop_MullOdd64Sx2, UNDEF_UNKNOWN) },
  ...
  { DEFOP(Iop_Cls64x2, UNDEF_UNKNOWN), },
