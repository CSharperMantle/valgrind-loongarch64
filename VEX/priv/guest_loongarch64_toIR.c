                               ...
                               IRTemp t3, IRTemp t2, IRTemp t1, IRTemp t0 )
{
   return binop(Iop_64HLtoV128,
                binop(Iop_32HLto64, binop(Iop_16HLto32, mkexpr(t7), mkexpr(t6)),
                      binop(Iop_16HLto32, mkexpr(t5), mkexpr(t4))),
                binop(Iop_32HLto64, binop(Iop_16HLto32, mkexpr(t3), mkexpr(t2)),
...
{
   return binop(Iop_64HLtoV128, binop(Iop_32HLto64, mkexpr(t3), mkexpr(t2)),
...
static IRExpr* mkV256from64s ( IRTemp t3, IRTemp t2,
                               IRTemp t1, IRTemp t0 )
{
   return binop(Iop_V128HLtoV256, mkV128from64s(t3, t2), mkV128from64s(t1, t0));
}
                               ...
                               IRTemp t1, IRTemp t0 )
{
   ...
   return binop(Iop_V128HLtoV256, mkV128from32s(t7, t6, t5, t4),
                mkV128from32s(t3, t2, t1, t0));
}

/* Construct a V256-bit value from sixteen 16-bit ints. */
static IRExpr* mkV256from16s ( IRTemp t15, IRTemp t14, IRTemp t13, IRTemp t12,
                               IRTemp t11, IRTemp t10, IRTemp t9,  IRTemp t8,
                               IRTemp t7,  IRTemp t6,  IRTemp t5,  IRTemp t4,
                               IRTemp t3,  IRTemp t2,  IRTemp t1,  IRTemp t0 )
{
   return binop(Iop_V128HLtoV256,
                mkV128from16s(t15, t14, t13, t12, t11, t10, t9, t8),
                mkV128from16s(t7, t6, t5, t4, t3, t2, t1, t0));
}
...
{
   const IROp ops[4] = {Iop_QAdd8Sx16, Iop_QAdd16Sx8, Iop_QAdd32Sx4,
                        Iop_QAdd64Sx2};
   vassert(size < 4);
   return ops[size];
}
...
{
   const IROp ops[4] = {Iop_QSub8Sx16, Iop_QSub16Sx8, Iop_QSub32Sx4,
                        Iop_QSub64Sx2};
   vassert(size < 4);
   return ops[size];
}
...
{
   const IROp ops[4] = {Iop_QAdd8Ux16, Iop_QAdd16Ux8, Iop_QAdd32Ux4,
                        Iop_QAdd64Ux2};
   vassert(size < 4);
   return ops[size];
}
...
{
   const IROp ops[4] = {Iop_QSub8Ux16, Iop_QSub16Ux8, Iop_QSub32Ux4,
                        Iop_QSub64Ux2};
   vassert(size < 4);
   return ops[size];
}
...
/* Expects `archinfo` and `dres`, and a Bool return value. */
#define STOP_ILL_IF_NO_HWCAP(hwcap_)                                           \
   do {                                                                        \
      if (!(archinfo->hwcaps & (hwcap_))) {                                    \
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRExpr* clz = unop(Iop_ClzNat32, not);
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRExpr* clz = unop(Iop_ClzNat32, getIReg32(rj));
   putIReg(rd, extendU(Ity_I32, clz));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRExpr* not = unop(Iop_Not32, getIReg32(rj));
   IRExpr* clz = unop(Iop_CtzNat32, not);
   putIReg(rd, extendU(Ity_I32, clz));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRExpr* clz = unop(Iop_CtzNat32, getIReg32(rj));
   putIReg(rd, extendU(Ity_I32, clz));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   putIReg(rd, unop(Iop_ClzNat64, not));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   putIReg(rd, unop(Iop_ClzNat64, getIReg64(rj)));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRExpr* not = unop(Iop_Not64, getIReg64(rj));
   putIReg(rd, unop(Iop_CtzNat64, not));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   putIReg(rd, unop(Iop_CtzNat64, getIReg64(rj)));
                           ...
                           const VexAbiInfo* abiinfo )
{
   ...
   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_LAM);
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_CPUCFG);
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_FP);
...
static Bool gen_xvclo_xvclz ( DisResult* dres, UInt insn,
                              const VexArchInfo* archinfo,
                              const VexAbiInfo* abiinfo )
{
   UInt xd      = SLICE(insn, 4, 0);
   ...
   static const char* nm[2] = {"xvclo", "xvclz"};

   DIP("%s.%s %s, %s\n", nm[insType], mkInsSize(insSz), nameXReg(xd),
       nameXReg(xj));
...
static IRTemp macro_v128pcnt ( IRTemp src, UInt insSz )
{
   IRTemp res   = newTemp(Ity_V128);
   ...
   switch (insSz) {
      case 0b00: {
         assign(res, unop(Iop_Cnt8x16, mkexpr(src)));
         break;
      }
      case 0b01: {
         assign(cnt8, unop(Iop_Cnt8x16, mkexpr(src)));
         assign(res, binop(Iop_Add16x8,
                           unop(Iop_WidenHIto16Ux8,
                                binop(Iop_PackEvenLanes8x16, mkexpr(cnt8),
                                      mkV128(0x0000))),
                           unop(Iop_WidenHIto16Ux8,
                                binop(Iop_PackOddLanes8x16, mkexpr(cnt8),
                                      mkV128(0x0000)))));
         break;
      }
      case 0b10: {
         ...
         assign(res, binop(Iop_Add32x4,
                           unop(Iop_WidenHIto32Ux4,
                                binop(Iop_PackEvenLanes16x8, mkexpr(add16),
                                      mkV128(0x0000))),
                           unop(Iop_WidenHIto32Ux4,
                                binop(Iop_PackOddLanes16x8, mkexpr(add16),
                                      mkV128(0x0000)))));
         break;
      }
      case 0b11: {
         ...
         assign(res, binop(Iop_Add64x2,
                           unop(Iop_WidenHIto64Ux2,
                                binop(Iop_PackEvenLanes32x4, mkexpr(add32),
                                      mkV128(0x0000))),
                           unop(Iop_WidenHIto64Ux2,
                                binop(Iop_PackOddLanes32x4, mkexpr(add32),
                                      mkV128(0x0000)))));
         break;
      }
      default: vassert(0); break;
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRTemp res = macro_v128pcnt(src, insSz);
...
static Bool gen_xvpcnt ( DisResult* dres, UInt insn,
                         const VexArchInfo* archinfo,
                         const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128pcnt(srcHi, insSz);
   IRTemp resLo = macro_v128pcnt(srcLo, insSz);
                              ...
                              const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 19, 17)) {
      case 0b011:
         mathOp = mkV128QADDS(insSz);
         szId   = insSz;
         break;
      case 0b100:
         mathOp = mkV128QSUBS(insSz);
         szId   = insSz;
         break;
      case 0b101:
         mathOp = mkV128QADDU(insSz);
         szId   = insSz + 4;
         break;
      case 0b110:
         mathOp = mkV128QSUBU(insSz);
         szId   = insSz + 4;
         break;
   ...
   DIP("%s.%s %s, %s, %s\n", name[isAdd], mkInsSize(szId), nameVReg(vd),
       nameVReg(vj), nameVReg(vk));
                                ...
                                const VexAbiInfo*  abiinfo )
{
   ...
   assign(resHi, binop(mathOp, mkexpr(jHi), mkexpr(kHi)));
   assign(resLo, binop(mathOp, mkexpr(jLo), mkexpr(kLo)));

   const HChar* name[2] = {"xvssub", "xvsadd"};

   DIP("%s.%s %s, %s, %s\n", name[isAdd], mkInsSize(szId), nameXReg(xd),
       nameXReg(xj), nameXReg(xk));
                                              ...
                                              const HChar** outNm )
{
   switch (op & 0b11111) {
      case 0b01111: {
         *outNm      = "vaddwev";
         *outPackOp  = mkV128PACKEV(insSz);
         *outMathOp  = mkV128ADD(insSz + 1);
         *outWidenOp = mkV128EXTHTS(insSz);
         *outId      = insSz;
         return True;
      }
      case 0b10000: {
         *outNm      = "vsubwev";
         *outPackOp  = mkV128PACKEV(insSz);
         *outMathOp  = mkV128SUB(insSz + 1);
         *outWidenOp = mkV128EXTHTS(insSz);
         return True;
      }
      case 0b10001: {
         *outNm      = "vaddwod";
         *outPackOp  = mkV128PACKOD(insSz);
         *outMathOp  = mkV128ADD(insSz + 1);
         *outWidenOp = mkV128EXTHTS(insSz);
         return True;
      }
                                  ...
                                  const VexAbiInfo* abiinfo )
{
   ...
   const HChar* nm;
   if (!macro_v128addw_v128subw_x_x_ops(SLICE(insn, 21, 17), insSz, &id,
                                        &mathOp, &packOp, &widenOp, &nm)) {
      return False;
   }
   ...
   DIP("%s.%s %s, %s, %s\n", nm, mkInsSize(id), nameVReg(vd), nameVReg(vj),
       nameVReg(vk));
                                    ...
                                    const VexAbiInfo* abiinfo )
{
   ...
   assign(argLLo, unop(widenOp, binop(packOp, mkexpr(jLo), mkV128(0x0000))));
   assign(argRLo, unop(widenOp, binop(packOp, mkexpr(kLo), mkV128(0x0000))));
   assign(argLHi, unop(widenOp, binop(packOp, mkexpr(jHi), mkV128(0x0000))));
   assign(argRHi, unop(widenOp, binop(packOp, mkexpr(kHi), mkV128(0x0000))));

   assign(resLo, binop(mathOp, mkexpr(argLLo), mkexpr(argRLo)));
   assign(resHi, binop(mathOp, mkexpr(argLHi), mkexpr(argRHi)));

   DIP("x%s.%s %s, %s, %s\n", nm, mkInsSize(id), nameXReg(xd), nameXReg(xj),
       nameXReg(xk));
                                    ...
                                    const VexAbiInfo* abiinfo )
{
   ...
   assign(argL, unop(mkV128EXTHTU(insSz),
                     binop(packOp, getVReg(vj), mkV128(0x0000))));
                                      ...
                                      const VexAbiInfo* abiinfo )
{
   ...
   assign(argLLo, unop(mkV128EXTHTU(insSz),
                       binop(packOp, mkexpr(jLo), mkV128(0x0000))));
   assign(argRLo, unop(mkV128EXTHTS(insSz),
                       binop(packOp, mkexpr(kLo), mkV128(0x0000))));
   assign(argLHi, unop(mkV128EXTHTU(insSz),
                       binop(packOp, mkexpr(jHi), mkV128(0x0000))));
   assign(argRHi, unop(mkV128EXTHTS(insSz),
                       binop(packOp, mkexpr(kHi), mkV128(0x0000))));
   assign(argL, mkV256from128s(argLHi, argLLo));
   assign(argR, mkV256from128s(argRHi, argRLo));
                        ...
                        const VexAbiInfo* abiinfo )
{
   ...
   IRTemp max = newTemp(Ity_V128);
   IRTemp min = newTemp(Ity_V128);

   IROp maxOp = isU ? mkV128MAXU(insSz) : mkV128MAXS(insSz);
   IROp minOp = isU ? mkV128MINU(insSz) : mkV128MINS(insSz);
   UInt szId  = isU ? (insSz + 4) : insSz;

   assign(max, binop(maxOp, getVReg(vj), getVReg(vk)));
   assign(min, binop(minOp, getVReg(vj), getVReg(vk)));

   DIP("vabsd.%s %s, %s, %s\n", mkInsSize(szId), nameVReg(vd), nameVReg(vj),
       nameVReg(vk));

   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_LSX);

   putVReg(vd, binop(mkV128SUB(insSz), mkexpr(max), mkexpr(min)));
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   IRTemp max = newTemp(Ity_V256);
   IRTemp min = newTemp(Ity_V256);

   IROp maxOp = isU ? mkV256MAXU(insSz) : mkV256MAXS(insSz);
   IROp minOp = isU ? mkV256MINU(insSz) : mkV256MINS(insSz);
   UInt szId  = isU ? (insSz + 4) : insSz;

   assign(max, binop(maxOp, getXReg(xj), getXReg(xk)));
   assign(min, binop(minOp, getXReg(xj), getXReg(xk)));

   DIP("xvabsd.%s %s, %s, %s\n", mkInsSize(szId), nameXReg(xd), nameXReg(xj),
       nameXReg(xk));

   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_LASX);

   putXReg(xd, binop(mkV256SUB(insSz), mkexpr(max), mkexpr(min)));
                              ...
                              const VexAbiInfo* abiinfo )
{
   ...
   assign(imm, mkU64(extend64(si5, 5)));
   switch (insSz) {
      case 0b00: {
         IRExpr* si5Expr = isU ? mkU8(si5) : unop(Iop_64to8, mkexpr(imm));
         assign(dup, unop(Iop_Dup8x16, si5Expr));
         break;
      }
      case 0b01: {
         IRExpr* si5Expr = isU ? mkU16(si5) : unop(Iop_64to16, mkexpr(imm));
         assign(dup, unop(Iop_Dup16x8, si5Expr));
         break;
      }
      case 0b10: {
         IRExpr* si5Expr = isU ? mkU32(si5) : unop(Iop_64to32, mkexpr(imm));
         assign(dup, unop(Iop_Dup32x4, si5Expr));
         break;
      }
      case 0b11: {
         IRExpr* si5Expr = isU ? mkU64(si5) : mkexpr(imm);
   ...
   putVReg(vd, binop(op, getVReg(vj), mkexpr(dup)));
...
/*
 * Multiply two V128 values with independent hi/lo halves.
 * 
 * For each half, compute: `Vh = narOp(mulOp(Lh, Rh)))`
 */
static IRExpr* macro_v128mul ( IRExpr* l, IRExpr* r, IROp mulOp, IROp narOp )
{
   return binop(
      Iop_64HLtoV128,
      unop(narOp,
           binop(mulOp, unop(Iop_V128HIto64, l), unop(Iop_V128HIto64, r))),
      unop(narOp, binop(mulOp, unop(Iop_V128to64, l), unop(Iop_V128to64, r))));
}

static Bool gen_vmul_vmuh ( DisResult* dres, UInt insn,
                            const VexArchInfo* archinfo,
                            const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   switch (insTy) {
      case 0b10: {
         if (insSz != 0b11) {
            assign(res, binop(mkV128MUL(insSz), mkexpr(argL), mkexpr(argR)));
         } else {
            assign(res, macro_v128mul(mkexpr(argL), mkexpr(argR), Iop_MullS64,
                                      Iop_128to64));
         }
         break;
      }
      case 0b11: {
         if (insSz != 0b11) {
            assign(res, binop(mkV128MUHS(insSz), mkexpr(argL), mkexpr(argR)));
         } else {
            assign(res, macro_v128mul(mkexpr(argL), mkexpr(argR), Iop_MullS64,
                                      Iop_128HIto64));
         }
      ...
      case 0b00: {
         if (insSz != 0b11) {
            assign(res, binop(mkV128MUHU(insSz), mkexpr(argL), mkexpr(argR)));
         } else {
            assign(res, macro_v128mul(mkexpr(argL), mkexpr(argR), Iop_MullU64,
                                      Iop_128HIto64));
         }
         szId += 4;
         break;
...
static Bool gen_xvmul_xvmuh ( DisResult* dres, UInt insn,
                              const VexArchInfo* archinfo,
                              const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   switch (insTy) {
      case 0b10: {
         if (insSz != 0b11) {
            assign(resHi, binop(mkV128MUL(insSz), mkexpr(jHi), mkexpr(kHi)));
            assign(resLo, binop(mkV128MUL(insSz), mkexpr(jLo), mkexpr(kLo)));
         } else {
            assign(resHi, macro_v128mul(mkexpr(jHi), mkexpr(kHi), Iop_MullS64,
                                        Iop_128to64));
            assign(resLo, macro_v128mul(mkexpr(jLo), mkexpr(kLo), Iop_MullS64,
                                        Iop_128to64));
         }
         break;
      }
      case 0b11: {
         if (insSz != 0b11) {
            assign(resHi, binop(mkV128MUHS(insSz), mkexpr(jHi), mkexpr(kHi)));
            assign(resLo, binop(mkV128MUHS(insSz), mkexpr(jLo), mkexpr(kLo)));
         } else {
            assign(resHi, macro_v128mul(mkexpr(jHi), mkexpr(kHi), Iop_MullS64,
                                        Iop_128HIto64));
            assign(resLo, macro_v128mul(mkexpr(jLo), mkexpr(kLo), Iop_MullS64,
      ...
      case 0b00: {
         if (insSz != 0b11) {
            assign(resHi, binop(mkV128MUHU(insSz), mkexpr(jHi), mkexpr(kHi)));
            assign(resLo, binop(mkV128MUHU(insSz), mkexpr(jLo), mkexpr(kLo)));
         } else {
            assign(resHi, macro_v128mul(mkexpr(jHi), mkexpr(kHi), Iop_MullU64,
                                        Iop_128HIto64));
            assign(resLo, macro_v128mul(mkexpr(jLo), mkexpr(kLo), Iop_MullU64,
                                        Iop_128HIto64));
         }
         szId += 4;
         break;
...
static Bool gen_vmulwevod_x_x ( DisResult* dres, UInt insn,
                                const VexArchInfo* archinfo,
                                const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = macro_v128mulw_x_x(getVReg(vj), getVReg(vk), insSz, isOd, isU);
...
static Bool gen_xvmulwevod_x_x ( DisResult* dres, UInt insn,
                                 const VexArchInfo* archinfo,
                                 const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128mulw_x_x(mkexpr(jHi), mkexpr(kHi), insSz, isOd, isU);
   IRTemp resLo = macro_v128mulw_x_x(mkexpr(jLo), mkexpr(kLo), insSz, isOd, isU);
...
static IRTemp macro_v128mulw_x_x_x ( IRExpr* j, IRExpr* k, UInt insSz, UInt isOd )
{
   ...
   switch (insSz) {
      case 0b00: /* .h.bu.b */
      case 0b01: /* .w.hu.h */ mulOp = mkV128MUL(insSz + 1); break;
      case 0b10: /* .d.wu.w */
      case 0b11: /* .q.du.d */ mulOp = Iop_MullU64; break;
      default:   vassert(0); break;
   }
   ...
   switch (insSz) {
      case 0b00: /* .h.bu.b */
      case 0b01: /* .w.hu.h */ {
         assign(wj, unop(mkV128EXTHTU(insSz), binop(packOp, j, mkV128(0x0000))));
         assign(wk, unop(mkV128EXTHTS(insSz), binop(packOp, k, mkV128(0x0000))));
      ...
      case 0b11: /* .q.du.d */ {
         ...
         assign(wjHi, unop(Iop_V128HIto64, mkexpr(wj)));
         assign(wkHi, unop(Iop_V128HIto64, mkexpr(wk)));

         /* https://github.com/qemu/qemu/blob/ece408818d27f745ef1b05fb3cc99a1e7a5bf580/tcg/tcg-op.c#L2479-L2493 */
         assign(tmp1, binop(Iop_MullU64, mkexpr(wjHi), mkexpr(wkHi)));
         assign(tmp1Hi, unop(Iop_128HIto64, mkexpr(tmp1)));
         assign(tmp1Lo, unop(Iop_128to64, mkexpr(tmp1)));
         /* Adjust for negative input for the signed k.  */
         assign(tmp2, binop(Iop_And64, mkexpr(wjHi),
                            binop(Iop_Sar64, mkexpr(wkHi), mkU8(63))));
         assign(resHi, binop(Iop_Sub64, mkexpr(tmp1Hi), mkexpr(tmp2)));
         assign(resLo, mkexpr(tmp1Lo));
         assign(res, mkV128from64s(resHi, resLo));
         break;
      }
      default: vassert(0); break;
   }
...
static Bool gen_vmulwevod_x_x_x ( DisResult* dres, UInt insn,
                                  const VexArchInfo* archinfo,
                                  const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = macro_v128mulw_x_x_x(getVReg(vj), getVReg(vk), insSz, isOd);
...
static Bool gen_xvmulwevod_x_x_x ( DisResult* dres, UInt insn,
                                   const VexArchInfo* archinfo,
                                   const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128mulw_x_x_x(mkexpr(jHi), mkexpr(kHi), insSz, isOd);
   IRTemp resLo = macro_v128mulw_x_x_x(mkexpr(jLo), mkexpr(kLo), insSz, isOd);
...
static IRTemp macro_v128divmod_b ( IRTemp argL, IRTemp argR, UInt isMod, UInt isU )
{
   IRTemp tI8[16];
   IRTemp res = newTemp(Ity_V128);

   IROp widenOp = isU ? Iop_8Uto32 : Iop_8Sto32;
   ...
   assign(res, mkV128from8s(tI8[15], tI8[14], tI8[13], tI8[12], tI8[11],
                            tI8[10], tI8[9], tI8[8], tI8[7], tI8[6], tI8[5],
                            tI8[4], tI8[3], tI8[2], tI8[1], tI8[0]));
                              ...
                              const VexAbiInfo* abiinfo )
{
   ...
   if (insSz == 0b11) {
      assign(res,
             macro_v128mul(mkexpr(j), mkexpr(k), Iop_MullS64, Iop_128to64));
   } else {
                                ...
                                const VexAbiInfo* abiinfo )
{
   ...
   if (insSz == 0b11) {
      assign(rHi,
             macro_v128mul(mkexpr(jHi), mkexpr(kHi), Iop_MullS64, Iop_128to64));
      assign(rLo,
             macro_v128mul(mkexpr(jLo), mkexpr(kLo), Iop_MullS64, Iop_128to64));
   } else {
      assign(rHi, binop(mkV128MUL(insSz), mkexpr(jHi), mkexpr(kHi)));
      assign(rLo, binop(mkV128MUL(insSz), mkexpr(jLo), mkexpr(kLo)));
   }
   ...
   putXReg(xd, binop(addOp, getXReg(xd), mkexpr(res)));

   return True;
}

static Bool gen_vmaddwevod_x_x ( DisResult* dres, UInt insn,
                                 const VexArchInfo* archinfo,
                                 const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = newTemp(Ity_V128);
   assign(res, binop(mkV128ADD(insSz + 1), getVReg(vd), mkexpr(mul)));
...
static Bool gen_xvmaddwevod_x_x ( DisResult* dres, UInt insn,
                                  const VexArchInfo* archinfo,
                                  const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp mulHi =
      macro_v128mulw_x_x(mkexpr(jHi), mkexpr(kHi), insSz, isOd, isU);
   IRTemp mulLo =
      macro_v128mulw_x_x(mkexpr(jLo), mkexpr(kLo), insSz, isOd, isU);
   assign(resHi, binop(mkV128ADD(insSz + 1), mkexpr(dHi), mkexpr(mulHi)));
   assign(resLo, binop(mkV128ADD(insSz + 1), mkexpr(dLo), mkexpr(mulLo)));
...
static Bool gen_vmaddwevod_x_x_x ( DisResult* dres, UInt insn,
                                   const VexArchInfo* archinfo,
                                   const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp mul = macro_v128mulw_x_x_x(getVReg(vj), getVReg(vk), insSz, isOd);
   IRTemp res = newTemp(Ity_V128);
   assign(res, binop(mkV128ADD(insSz + 1), getVReg(vd), mkexpr(mul)));
...
static Bool gen_xvmaddwevod_x_x_x ( DisResult* dres, UInt insn,
                                    const VexArchInfo* archinfo,
                                    const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp mulHi = macro_v128mulw_x_x_x(mkexpr(jHi), mkexpr(kHi), insSz, isOd);
   IRTemp mulLo = macro_v128mulw_x_x_x(mkexpr(jLo), mkexpr(kLo), insSz, isOd);
   assign(resHi, binop(mkV128ADD(insSz + 1), mkexpr(dHi), mkexpr(mulHi)));
   assign(resLo, binop(mkV128ADD(insSz + 1), mkexpr(dLo), mkexpr(mulLo)));
...
static IRTemp macro_v128divmod_h ( IRTemp argL, IRTemp argR, UInt isMod, UInt isU )
{
   IRTemp tI16[8];
   IRTemp res = newTemp(Ity_V128);

   IROp widenOp = isU ? Iop_16Uto32 : Iop_16Sto32;
   IROp mathOp  = isMod ? (isU ? Iop_DivModU32to32 : Iop_DivModS32to32)
                        : (isU ? Iop_DivU32 : Iop_DivS32);
   ...
   assign(res, mkV128from16s(tI16[7], tI16[6], tI16[5], tI16[4], tI16[3],
                             tI16[2], tI16[1], tI16[0]));
   return res;
}

static IRTemp macro_v128divmod_w ( IRTemp argL, IRTemp argR, UInt isMod, UInt isU )
{
   IRTemp tI32[4];
   IRTemp res = newTemp(Ity_V128);
...
static IRTemp macro_v128divmod_d ( IRTemp argL, IRTemp argR, UInt isMod, UInt isU )
{
   ...
   IRTemp res = newTemp(Ity_V128);
   assign(lHi, unop(Iop_V128HIto64, mkexpr(argL)));
   assign(rHi, unop(Iop_V128HIto64, mkexpr(argR)));
   assign(lLo, unop(Iop_V128to64, mkexpr(argL)));
   assign(rLo, unop(Iop_V128to64, mkexpr(argR)));
...
static Bool gen_vdiv_vmod ( DisResult* dres, UInt insn,
                            const VexArchInfo* archinfo,
                            const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   switch (insSz) {
      case 0b00: res = macro_v128divmod_b(j, k, isMod, isU); break;
      case 0b01: res = macro_v128divmod_h(j, k, isMod, isU); break;
      case 0b10: res = macro_v128divmod_w(j, k, isMod, isU); break;
      case 0b11: res = macro_v128divmod_d(j, k, isMod, isU); break;
      default:   vassert(0); break;
   }
...
static Bool gen_xvdiv_xvmod ( DisResult* dres, UInt insn,
                              const VexArchInfo* archinfo,
                              const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp kHi   = IRTemp_INVALID;
   IRTemp kLo   = IRTemp_INVALID;
   IRTemp resHi = IRTemp_INVALID;
   IRTemp resLo = IRTemp_INVALID;
   assign(j, getXReg(xj));
   assign(k, getXReg(xk));
   breakupV256toV128s(j, &jHi, &jLo);
   breakupV256toV128s(k, &kHi, &kLo);
   ...
   switch (insSz) {
      case 0b00: {
         resHi = macro_v128divmod_b(jHi, kHi, isMod, isU);
         resLo = macro_v128divmod_b(jLo, kLo, isMod, isU);
         break;
      }
      case 0b01: {
         resHi = macro_v128divmod_h(jHi, kHi, isMod, isU);
         resLo = macro_v128divmod_h(jLo, kLo, isMod, isU);
         break;
      }
      case 0b10: {
         resHi = macro_v128divmod_w(jHi, kHi, isMod, isU);
         resLo = macro_v128divmod_w(jLo, kLo, isMod, isU);
         break;
      }
      case 0b11: {
         resHi = macro_v128divmod_d(jHi, kHi, isMod, isU);
         resLo = macro_v128divmod_d(jLo, kLo, isMod, isU);
         break;
      }
      default: vassert(0); break;
   }
                          ...
                          const VexAbiInfo*  abiinfo )
{
   ...
   /* clang-format off */
   switch (insTy) {
      case 0b0100: srcSz = 0; dstSz = 1; isU = False; break; /* h.b */
      case 0b0101: srcSz = 0; dstSz = 2; isU = False; break; /* w.b */
      case 0b0110: srcSz = 0; dstSz = 3; isU = False; break; /* d.b */
      case 0b0111: srcSz = 1; dstSz = 2; isU = False; break; /* w.h */
      case 0b1000: srcSz = 1; dstSz = 3; isU = False; break; /* d.h */
      case 0b1001: srcSz = 2; dstSz = 3; isU = False; break; /* d.w */
      case 0b1010: srcSz = 0; dstSz = 1; isU = True; break;  /* hu.bu */
      case 0b1011: srcSz = 0; dstSz = 2; isU = True; break;  /* wu.bu */
      case 0b1100: srcSz = 0; dstSz = 3; isU = True; break;  /* du.bu */
      case 0b1101: srcSz = 1; dstSz = 2; isU = True; break;  /* wu.hu */
      case 0b1110: srcSz = 1; dstSz = 3; isU = True; break;  /* du.hu */
      case 0b1111: srcSz = 2; dstSz = 3; isU = True; break;  /* du.wu */
      default:     return False;
   }
   /* clang-format on */
   ...
   IROp getElemOp = mkV128GETELEM(srcSz);

   switch (dstSz) {
      case 1: {
         IRTemp i16[16];
         for (UInt i = 0; i < 16; i++) {
            i16[i] = newTemp(Ity_I16);
            assign(i16[i], unop(isU ? Iop_8Uto16 : Iop_8Sto16,
                                binop(getElemOp, mkexpr(jLo), mkU8(i))));
         }
         assign(res,
                mkV256from16s(i16[15], i16[14], i16[13], i16[12], i16[11],
                              i16[10], i16[9], i16[8], i16[7], i16[6], i16[5],
                              i16[4], i16[3], i16[2], i16[1], i16[0]));
         break;
      }
      case 2: {
         IRTemp i32[8];
         for (UInt i = 0; i < 8; i++) {
            i32[i] = newTemp(Ity_I32);

            IRExpr* const srcElem = binop(getElemOp, mkexpr(jLo), mkU8(i));
            switch (srcSz) {
               case 0:
                  assign(i32[i], unop(isU ? Iop_8Uto32 : Iop_8Sto32, srcElem));
                  break;
               case 1:
                  assign(i32[i],
                         unop(isU ? Iop_16Uto32 : Iop_16Sto32, srcElem));
                  break;
               default: vassert(0); break;
            }
         }
         assign(res, mkV256from32s(i32[7], i32[6], i32[5], i32[4], i32[3],
                                   i32[2], i32[1], i32[0]));
         break;
      }
      case 3: {
         IRTemp i64[4];
         for (UInt i = 0; i < 4; i++) {
            i64[i] = newTemp(Ity_I64);

            IRExpr* const srcElem = binop(getElemOp, mkexpr(jLo), mkU8(i));
            switch (srcSz) {
               case 0: {
                  IRExpr* const t32 =
                     unop(isU ? Iop_8Uto32 : Iop_8Sto32, srcElem);
                  assign(i64[i], unop(isU ? Iop_32Uto64 : Iop_32Sto64, t32));
                  break;
               }
               case 1: {
                  IRExpr* const t32 =
               ...
               case 2:
                  assign(i64[i],
                         unop(isU ? Iop_32Uto64 : Iop_32Sto64, srcElem));
                  break;
               default: vassert(0); break;
            }
         }
         assign(res, mkV256from64s(i64[3], i64[2], i64[1], i64[0]));
         break;
      }
      default: vassert(0); break;
   }

   const HChar* ns[16] = {"",      "",      "",      "",     "h.b",   "w.b",
                          "d.b",   "w.h",   "d.h",   "d.w",  "hu.bu", "wu.bu",
                          "du.bu", "wu.hu", "du.hu", "du.wu"};

   DIP("vext2xv.%s %s, %s\n", ns[insTy], nameXReg(xd), nameXReg(xj));
...
static IRTemp macro_v128signcov ( IRTemp argJ, IRTemp argK, UInt insSz )
{
   vassert(insSz < 4);
   ...
   assign(eq, unop(Iop_NotV128,
                   binop(mkV128CMPEQ(insSz), mkexpr(argJ), mkV128(0x0000))));
   assign(lt, binop(Iop_AndV128,
                    binop(mkV128SARN(insSz), mkexpr(argJ), mkU8(saramt[insSz])),
                    binop(mkV128SUB(insSz), mkV128(0x0000), mkexpr(argK))));
   assign(gt, binop(Iop_AndV128,
                    binop(mkV128CMPEQ(insSz),
                          binop(mkV128SARN(insSz), mkexpr(argJ),
                                mkU8(saramt[insSz])),
                          mkV128(0x0000)),
                    mkexpr(argK)));
   assign(res, binop(Iop_AndV128, binop(Iop_OrV128, mkexpr(lt), mkexpr(gt)),
                     mkexpr(eq)));
                           ...
                           const VexAbiInfo*  abiinfo )
{
   ...
   IRTemp res = macro_v128signcov(j, k, insSz);
                            ...
                            const VexAbiInfo*  abiinfo )
{
   ...
   IRTemp resHi = macro_v128signcov(jHi, kHi, insSz);
   IRTemp resLo = macro_v128signcov(jLo, kLo, insSz);
...
static Bool gen_xvbiti ( DisResult* dres, UInt insn,
                         const VexArchInfo* archinfo,
                         const VexAbiInfo*  abiinfo )
{
   UInt xd     = SLICE(insn, 4, 0);
   ...
   switch (insTy) {
      case 0b00:
         assign(resHi, binop(Iop_AndV128, mkexpr(srcHi),
                             unop(Iop_NotV128, mkexpr(argR))));
         assign(resLo, binop(Iop_AndV128, mkexpr(srcLo),
                             unop(Iop_NotV128, mkexpr(argR))));
         break;
      case 0b01:
         assign(resHi, binop(Iop_OrV128, mkexpr(srcHi), mkexpr(argR)));
         assign(resLo, binop(Iop_OrV128, mkexpr(srcLo), mkexpr(argR)));
         break;
      case 0b10:
         assign(resHi, binop(Iop_XorV128, mkexpr(srcHi), mkexpr(argR)));
         assign(resLo, binop(Iop_XorV128, mkexpr(srcLo), mkexpr(argR)));
         break;
      default:
         vassert(0);
         break;
...
static IRTemp macro_v128msk_b ( IRTemp shr )
{
   UInt i;
   IRTemp tmp[16];
...
static IRTemp macro_v128msk_h ( IRTemp shr )
{
   UInt i;
   IRTemp tmp[8];
   IRTemp tOr = newTemp(Ity_I32);
...
static IRTemp macro_v128msk_w ( IRTemp shr )
{
   UInt i;
   IRTemp tmp[4];
   IRTemp tOr = newTemp(Ity_I32);
...
static IRTemp macro_v128msk_d ( IRTemp shr )
{
   UInt i;
   IRTemp tmp[2];
   IRTemp res = newTemp(Ity_V128);
                       ...
                       const VexAbiInfo*  abiinfo )
{
   ...
   switch (insTy) {
      case 0b00: {
         ...
         switch (insSz) {
            case 0b00: res = macro_v128msk_b(shr); break;
            case 0b01: res = macro_v128msk_h(shr); break;
            case 0b10: res = macro_v128msk_w(shr); break;
            case 0b11: res = macro_v128msk_d(shr); break;
            default:   vassert(0); break;
         }
         break;
      }
                        ...
                        const VexAbiInfo*  abiinfo )
{
   ...
   switch (insTy) {
      case 0b00: {
         ...
         assign(cmpHi, binop(mkV128CMPGTS(insSz), mkV128(0x0000), mkexpr(hi)));
         assign(shrHi,
                binop(mkV128SHRN(insSz), mkexpr(cmpHi), mkU8(shrNum[insSz])));
         assign(cmpLo, binop(mkV128CMPGTS(insSz), mkV128(0x0000), mkexpr(lo)));
         assign(shrLo,
                binop(mkV128SHRN(insSz), mkexpr(cmpLo), mkU8(shrNum[insSz])));

         switch (insSz) {
            case 0b00:
               assign(res,
                      binop(Iop_V128HLtoV256, mkexpr(macro_v128msk_b(shrHi)),
                            mkexpr(macro_v128msk_b(shrLo))));
               break;
            case 0b01:
               assign(res,
                      binop(Iop_V128HLtoV256, mkexpr(macro_v128msk_h(shrHi)),
                            mkexpr(macro_v128msk_h(shrLo))));
               break;
            case 0b10:
               assign(res,
                      binop(Iop_V128HLtoV256, mkexpr(macro_v128msk_w(shrHi)),
                            mkexpr(macro_v128msk_w(shrLo))));
               break;
            case 0b11:
               assign(res,
                      binop(Iop_V128HLtoV256, mkexpr(macro_v128msk_d(shrHi)),
                            mkexpr(macro_v128msk_d(shrLo))));
               break;
            default: vassert(0); break;
         }
         break;
      ...
      case 0b01: {
         ...
         assign(res, binop(Iop_V128HLtoV256, mkexpr(macro_v128msk_b(shrHi)),
                           mkexpr(macro_v128msk_b(shrLo))));
         break;
      }
      case 0b10: {
...
static Bool gen_xvcmpi_integer ( DisResult* dres, UInt insn,
                                 const VexArchInfo* archinfo,
                                 const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   switch (insSz) {
      case 0b00:
         si5Expr = isS ? unop(Iop_64to8, mkexpr(s64)) : mkU8(si5);
         assign(imm, unop(Iop_Dup8x16, si5Expr));
         break;
      case 0b01:
         si5Expr = isS ? unop(Iop_64to16, mkexpr(s64)) : mkU16(si5);
         assign(imm, unop(Iop_Dup16x8, si5Expr));
         break;
      case 0b10:
         si5Expr = isS ? unop(Iop_64to32, mkexpr(s64)) : mkU32(si5);
         assign(imm, unop(Iop_Dup32x4, si5Expr));
         break;
      case 0b11:
         si5Expr = isS ? mkexpr(s64) : mkU64(si5);
         assign(imm, binop(Iop_64HLtoV128, si5Expr, si5Expr));
         break;
      default:
         vassert(0);
         break;
   ...
   switch (insTy) {
      case 0b000:
         assign(resHi, binop(mkV128CMPEQ(insSz), mkexpr(srcHi), mkexpr(imm)));
         assign(resLo, binop(mkV128CMPEQ(insSz), mkexpr(srcLo), mkexpr(imm)));
         break;
      case 0b001:
         assign(resHi,
                binop(Iop_OrV128,
                      binop(mkV128CMPGTS(insSz), mkexpr(imm), mkexpr(srcHi)),
                      binop(mkV128CMPEQ(insSz), mkexpr(srcHi), mkexpr(imm))));
         assign(resLo,
                binop(Iop_OrV128,
                      binop(mkV128CMPGTS(insSz), mkexpr(imm), mkexpr(srcLo)),
                      binop(mkV128CMPEQ(insSz), mkexpr(srcLo), mkexpr(imm))));
         break;
      case 0b010:
         assign(resHi,
                binop(Iop_OrV128,
                      binop(mkV128CMPGTU(insSz), mkexpr(imm), mkexpr(srcHi)),
                      binop(mkV128CMPEQ(insSz), mkexpr(srcHi), mkexpr(imm))));
         assign(resLo,
                binop(Iop_OrV128,
                      binop(mkV128CMPGTU(insSz), mkexpr(imm), mkexpr(srcLo)),
                      binop(mkV128CMPEQ(insSz), mkexpr(srcLo), mkexpr(imm))));
         szId = insSz + 4;
         break;
      case 0b011:
         assign(resHi, binop(mkV128CMPGTS(insSz), mkexpr(imm), mkexpr(srcHi)));
         assign(resLo, binop(mkV128CMPGTS(insSz), mkexpr(imm), mkexpr(srcLo)));
         break;
      case 0b100:
         assign(resHi, binop(mkV128CMPGTU(insSz), mkexpr(imm), mkexpr(srcHi)));
         assign(resLo, binop(mkV128CMPGTU(insSz), mkexpr(imm), mkexpr(srcLo)));
         szId = insSz + 4;
         break;
      default:
         vassert(0);
                           ...
                           const VexAbiInfo*  abiinfo )
{
   ...
   DIP("xvreplve.%s %s, %s, %s", mkInsSize(insSz), nameXReg(xd), nameXReg(xj),
       nameIReg(rk));
                               ...
                               const VexAbiInfo*  abiinfo )
{
   ...
   UInt uImm, insSz;
   if ((insImm & 0b110000) == 0b100000) {        // 10????; b
      uImm  = insImm & 0b001111;
      insSz = 0;
   } else if ((insImm & 0b111000) == 0b110000) { // 110???; h
      uImm  = insImm & 0b000111;
      insSz = 1;
   } else if ((insImm & 0b111100) == 0b111000) { // 1110??; w
      uImm  = insImm & 0b000011;
      insSz = 2;
   } else if ((insImm & 0b111110) == 0b111100) { // 11110?; d
      uImm  = insImm & 0b000001;
      insSz = 3;
   } else {
      return False;
   }
   ...
   IRExpr* irLo = binop(mkV128GETELEM(insSz), mkexpr(jLo), mkU8(uImm));
   IRExpr* irHi = binop(mkV128GETELEM(insSz), mkexpr(jHi), mkU8(uImm));
   switch (insSz) {
      case 0:
         assign(resHi, unop(Iop_Dup8x16, irHi));
         assign(resLo, unop(Iop_Dup8x16, irLo));
   ...
   DIP("xvrepl128vei.%s %s, %s, %u", mkInsSize(insSz), nameXReg(xd),
       nameXReg(xj), uImm);
                         ...
                         const VexAbiInfo* abiinfo )
{
   ...
   switch (insTy) {
      case 0b00:
         assign(res, binop(mkV128SHL(insSz), getVReg(vj), getVReg(vk))); break;
      case 0b01:
         assign(res, binop(mkV128SHR(insSz), getVReg(vj), getVReg(vk))); break;
      case 0b10:
         assign(res, binop(mkV128SAR(insSz), getVReg(vj), getVReg(vk))); break;
      default: return False;
   }
                          ...
                          const VexAbiInfo* abiinfo )
{
   ...
   switch (insTy) {
      case 0b00:
         assign(resHi, binop(mkV128SHL(insSz), mkexpr(jHi), mkexpr(kHi)));
         assign(resLo, binop(mkV128SHL(insSz), mkexpr(jLo), mkexpr(kLo)));
         break;
      case 0b01:
         assign(resHi, binop(mkV128SHR(insSz), mkexpr(jHi), mkexpr(kHi)));
         assign(resLo, binop(mkV128SHR(insSz), mkexpr(jLo), mkexpr(kLo)));
         break;
      case 0b10:
         assign(resHi, binop(mkV128SAR(insSz), mkexpr(jHi), mkexpr(kHi)));
         assign(resLo, binop(mkV128SAR(insSz), mkexpr(jLo), mkexpr(kLo)));
         break;
      default: return False;
   }
...
static IRTemp macro_v128srr ( IRTemp sJ, IRTemp sK, IROp shrOp, UInt insSz )
{
   IRTemp argL   = newTemp(Ity_V128);
   IRTemp argR   = newTemp(Ity_V128);
   ...
   const UInt shlamt[4] = {5, 12, 27, 58};
   const UInt shramt[4] = {7, 15, 31, 63};

   switch (insSz) {
      case 0b00: assign(imm, mkU64(0x808080808080808ull)); break;
      case 0b01: assign(imm, mkU64(0x10001000100010ull)); break;
      case 0b10: assign(imm, mkU64(0x2000000020ull)); break;
      case 0b11: assign(imm, mkU64(64ull)); break;
      default:   vassert(0); break;
   }

   assign(subR, mkV128from64s(imm, imm));
   assign(argL, binop(shrOp, mkexpr(sJ), mkexpr(sK)));
   assign(subRes, binop(mkV128SUB(insSz), mkexpr(subR), mkexpr(sK)));
   assign(notRes, unop(Iop_NotV128, binop(mkV128CMPEQ(insSz),
                                          binop(mkV128SHLN(insSz), mkexpr(sK),
                                                mkU8(shlamt[insSz])),
                                          mkV128(0x0000))));
   assign(argR, binop(mkV128SHRN(insSz),
                      binop(Iop_AndV128,
                            binop(mkV128SHL(insSz), mkexpr(sJ), mkexpr(subRes)),
                            mkexpr(notRes)),
                      mkU8(shramt[insSz])));
   assign(res, binop(mkV128ADD(insSz), mkexpr(argL), mkexpr(argR)));

   return res;
}

static Bool gen_vsrlr_vsrar ( DisResult* dres, UInt insn,
                              const VexArchInfo* archinfo,
                              const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = macro_v128srr(j, k, shrOp, insSz);
...
static Bool gen_xvsrlr_xvsrar ( DisResult* dres, UInt insn,
                                const VexArchInfo* archinfo,
                                const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128srr(jHi, kHi, shrOp, insSz);
   IRTemp resLo = macro_v128srr(jLo, kLo, shrOp, insSz);
...
static IRTemp macro_v128rotr ( IRTemp sJ, IRTemp sK, UInt insSz )
{
   IRTemp dup = newTemp(Ity_V128);
   ...
   switch (insSz) {
      case 0b00: {
         ...
         div = macro_v128divmod_b(sK, dup, 1, 1);
         break;
      }
      case 0b01: {
         assign(dup, unop(Iop_Dup16x8, mkU16(16)));
         div = macro_v128divmod_h(sK, dup, 1, 1);
         break;
      }
      case 0b10: {
         assign(dup, unop(Iop_Dup32x4, mkU32(32)));
         div = macro_v128divmod_w(sK, dup, 1, 1);
         break;
      }
      case 0b11: {
         assign(dup, binop(Iop_64HLtoV128, mkU64(64), mkU64(64)));
         div = macro_v128divmod_d(sK, dup, 1, 1);
         break;
      }
      default: vassert(0); break;
   }

   assign(sub, binop(mkV128SUB(insSz), mkexpr(dup), mkexpr(div)));
   assign(res,
          binop(Iop_OrV128, binop(mkV128SHR(insSz), mkexpr(sJ), mkexpr(sK)),
                binop(mkV128SHL(insSz), mkexpr(sJ), mkexpr(sub))));

   return res;
}

static Bool gen_vrotr ( DisResult* dres, UInt insn,
                        const VexArchInfo* archinfo,
                        const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = macro_v128rotr(j, k, insSz);
...
static Bool gen_xvrotr ( DisResult* dres, UInt insn,
                         const VexArchInfo* archinfo,
                         const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128rotr(jHi, kHi, insSz);
   IRTemp resLo = macro_v128rotr(jLo, kLo, insSz);
...
static IRTemp macro_v128srxn ( IRTemp sJ, IRTemp sK, IROp shOp, UInt insSz )
{
   IRTemp arg = newTemp(Ity_V128);
   IRTemp res = newTemp(Ity_V128);

   assign(arg, binop(shOp, mkexpr(sJ), mkexpr(sK)));
   assign(res, binop(mkV128PACKEV(insSz - 1), mkV128(0x0000), mkexpr(arg)));
                              ...
                              const VexAbiInfo* abiinfo )
{
   ...
   IRTemp res = macro_v128srxn(j, k, shOp, insSz);

   const HChar* nm    = isSar ? "vsran" : "vsrln";
   const HChar* sz[4] = {NULL, "b.h", "h.w", "w.d"};

   DIP("%s.%s %s, %s, %s\n", nm, sz[insSz], nameVReg(vd), nameVReg(vj),
       nameVReg(vk));
                                ...
                                const VexAbiInfo* abiinfo )
{
   ...
   IRTemp resHi = macro_v128srxn(jHi, kHi, shOp, insSz);
   IRTemp resLo = macro_v128srxn(jLo, kLo, shOp, insSz);

   const HChar* nm    = isSar ? "xvsran" : "xvsrln";
   const HChar* sz[4] = {NULL, "b.h", "h.w", "w.d"};

   DIP("%s.%s %s, %s, %s\n", nm, sz[insSz], nameXReg(xd), nameXReg(xj),
       nameXReg(xk));
...
static IRTemp macro_v128srxrn ( IRTemp sJ, IRTemp sK, IROp shOp, UInt insSz )
{
   IRTemp arg = newTemp(Ity_V128);
   IRTemp res = newTemp(Ity_V128);

   arg = macro_v128srr(sJ, sK, shOp, insSz);
   assign(res, binop(mkV128PACKEV(insSz - 1), mkV128(0x0000), mkexpr(arg)));

   return res;
}

static Bool gen_vsrlrn_vsrarn ( DisResult* dres, UInt insn,
                                const VexArchInfo* archinfo,
                                const VexAbiInfo* abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   IRTemp res = macro_v128srxrn(sJ, sK, shOp, insSz);
...
static Bool gen_xvsrlrn_xvsrarn ( DisResult* dres, UInt insn,
                                  const VexArchInfo* archinfo,
                                  const VexAbiInfo* abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp resHi = macro_v128srxrn(jHi, kHi, shOp, insSz);
   IRTemp resLo = macro_v128srxrn(jLo, kLo, shOp, insSz);

   const HChar* nm    = isSar ? "xvsrarn" : "xvsrlrn";
   const HChar* sz[4] = {NULL, "b.h", "h.w", "w.d"};
                       ...
                       const VexAbiInfo* abiinfo )
{
   ...
   switch (SLICE(insn, 19, 17)) {
      case 0b011:
         nm = "xvpackev";
         assign(argLLo, binop(mkV128PACKEV(insSz), mkexpr(jLo), mkV128(0x0000)));
         assign(argRLo, binop(mkV128PACKEV(insSz), mkexpr(kLo), mkV128(0x0000)));
         assign(resLo, binop(mkV128INTERLEAVEHI(insSz), mkexpr(argLLo),
                             mkexpr(argRLo)));
         assign(argLHi, binop(mkV128PACKEV(insSz), mkexpr(jHi), mkV128(0x0000)));
         assign(argRHi, binop(mkV128PACKEV(insSz), mkexpr(kHi), mkV128(0x0000)));
         assign(resHi, binop(mkV128INTERLEAVEHI(insSz), mkexpr(argLHi),
                             mkexpr(argRHi)));
         break;
      case 0b100:
         nm = "xvpackod";
         assign(argLLo, binop(mkV128PACKOD(insSz), mkexpr(jLo), mkV128(0x0000)));
         assign(argRLo, binop(mkV128PACKOD(insSz), mkexpr(kLo), mkV128(0x0000)));
         assign(resLo, binop(mkV128INTERLEAVEHI(insSz), mkexpr(argLLo),
                             mkexpr(argRLo)));
         assign(argLHi, binop(mkV128PACKOD(insSz), mkexpr(jHi), mkV128(0x0000)));
         assign(argRHi, binop(mkV128PACKOD(insSz), mkexpr(kHi), mkV128(0x0000)));
         assign(resHi, binop(mkV128INTERLEAVEHI(insSz), mkexpr(argLHi),
                             mkexpr(argRHi)));
         break;
      case 0b101:
         nm = "xvilvl";
         assign(resLo,
                binop(mkV128INTERLEAVELO(insSz), mkexpr(jLo), mkexpr(kLo)));
         assign(resHi,
                binop(mkV128INTERLEAVELO(insSz), mkexpr(jHi), mkexpr(kHi)));
         break;
      case 0b110:
         nm = "xvilvh";
         assign(resLo,
                binop(mkV128INTERLEAVEHI(insSz), mkexpr(jLo), mkexpr(kLo)));
         assign(resHi,
                binop(mkV128INTERLEAVEHI(insSz), mkexpr(jHi), mkexpr(kHi)));
         break;
      case 0b111:
         nm = "xvpickev";
         assign(resLo, binop(mkV128PACKEV(insSz), mkexpr(jLo), mkexpr(kLo)));
         assign(resHi, binop(mkV128PACKEV(insSz), mkexpr(jHi), mkexpr(kHi)));
         break;
      case 0b000:
         nm = "xvpickod";
         assign(resLo, binop(mkV128PACKOD(insSz), mkexpr(jLo), mkexpr(kLo)));
         assign(resHi, binop(mkV128PACKOD(insSz), mkexpr(jHi), mkexpr(kHi)));
         break;
      default:
         return False;
   }
...
static Bool gen_vbitseli_b ( DisResult* dres, UInt insn,
                             const VexArchInfo* archinfo,
                             const VexAbiInfo*  abiinfo )
{
   UInt vd  = SLICE(insn, 4, 0);
   ...
   IRTemp a = newTemp(Ity_V128);
   IRTemp b = newTemp(Ity_V128);
   assign(a, binop(Iop_AndV128, getVReg(vd), unop(Iop_Dup8x16, mkU8(ui8))));
   assign(b, binop(Iop_AndV128, getVReg(vj), unop(Iop_NotV128, getVReg(vd))));

   DIP("vbitseli.b %s, %s, %u", nameVReg(vd), nameVReg(vj), ui8);

   STOP_ILL_IF_NO_HWCAP(VEX_HWCAPS_LOONGARCH_LSX);

   putVReg(vd, binop(Iop_OrV128, mkexpr(a), mkexpr(b)));
...
static Bool gen_xvbitseli_b ( DisResult* dres, UInt insn,
                              const VexArchInfo* archinfo,
                              const VexAbiInfo*  abiinfo )
{
   UInt xd  = SLICE(insn, 4, 0);
   ...
   IRTemp resHi  = newTemp(Ity_V128);
   IRTemp resLo  = newTemp(Ity_V128);
   IRTemp immui8 = newTemp(Ity_V128);
   IRTemp d      = newTemp(Ity_V256);
   IRTemp j      = newTemp(Ity_V256);
   IRTemp dHi    = IRTemp_INVALID;
   IRTemp dLo    = IRTemp_INVALID;
   ...
   assign(immui8, unop(Iop_Dup8x16, mkU8(ui8)));

   assign(
      resHi,
      binop(Iop_OrV128, binop(Iop_AndV128, mkexpr(dHi), mkexpr(immui8)),
            binop(Iop_AndV128, mkexpr(jHi), unop(Iop_NotV128, mkexpr(dHi)))));
   assign(
      resLo,
      binop(Iop_OrV128, binop(Iop_AndV128, mkexpr(dLo), mkexpr(immui8)),
            binop(Iop_AndV128, mkexpr(jLo), unop(Iop_NotV128, mkexpr(dLo)))));
...
static IRTemp macro_v128shuf_h ( IRTemp sHi, IRTemp sLo, IRTemp sId )
{
   IRTemp id[8], res[8];
...
static IRTemp macro_v128shuf_w ( IRTemp sHi, IRTemp sLo, IRTemp sId )
{
   IRTemp id[4], res[4];
   IRTemp out = newTemp(Ity_V128);
...
static IRTemp macro_v128shuf_d ( IRTemp sHi, IRTemp sLo, IRTemp sId )
{
   IRTemp id[2], res[2];
   IRTemp out = newTemp(Ity_V128);
...
static Bool gen_vshuf_hwd ( DisResult* dres, UInt insn,
                            const VexArchInfo* archinfo,
                            const VexAbiInfo*  abiinfo )
{
   UInt vd    = SLICE(insn, 4, 0);
   ...
   assign(id, getVReg(vd));

   switch (insSz) {
      case 0b01: res = macro_v128shuf_h(hi, lo, id); break;
      case 0b10: res = macro_v128shuf_w(hi, lo, id); break;
      case 0b11: res = macro_v128shuf_d(hi, lo, id); break;
      default: vassert(0); break;
   }
...
static Bool gen_xvshuf_hwd ( DisResult* dres, UInt insn,
                             const VexArchInfo* archinfo,
                             const VexAbiInfo*  abiinfo )
{
   UInt xd    = SLICE(insn, 4, 0);
   ...
   IRTemp hi    = newTemp(Ity_V256);
   IRTemp lo    = newTemp(Ity_V256);
   IRTemp id    = newTemp(Ity_V256);
   ...
   switch (insSz) {
      case 0b01: {
         resHi = macro_v128shuf_h(hiHi, loHi, idHi);
         resLo = macro_v128shuf_h(hiLo, loLo, idLo);
         break;
      }
      case 0b10: {
         resHi = macro_v128shuf_w(hiHi, loHi, idHi);
         resLo = macro_v128shuf_w(hiLo, loLo, idLo);
         break;
      }
      case 0b11: {
         resHi = macro_v128shuf_d(hiHi, loHi, idHi);
         resLo = macro_v128shuf_d(hiLo, loLo, idLo);
         break;
      }
      default: vassert(0); break;
   }
                          ...
                          const VexAbiInfo*  abiinfo )
{
   ...
   switch (insSz) {
      case 0b01: {
         ...
         breakupV256to32s(sJ, &j[7], &j[6], &j[5], &j[4], &j[3], &j[2], &j[1],
                          &j[0]);
         breakupV256to32s(sD, &d[7], &d[6], &d[5], &d[4], &d[3], &d[2], &d[1],
                          &d[0]);
         assign(res, mkV256from32s(d[id3 + 4], d[id2 + 4], j[id1 + 4],
                                   j[id0 + 4], d[id3], d[id2], j[id1], j[id0]));
         break;
      }
      case 0b10: {
         IRTemp s[4];
                           ...
                           const VexAbiInfo*  abiinfo )
{
   ...
   switch (insSz) {
      case 0b00: {
         assign(addr,
                binop(Iop_Add64, getIReg64(rj), mkU64(extend64(sImm, 12))));
         assign(dup, unop(Iop_Dup8x16, load(Ity_I8, mkexpr(addr))));
         break;
      }
      case 0b01: {
         assign(addr, binop(Iop_Add64, getIReg64(rj),
                            mkU64(extend64(sImm << 1, 12))));
         assign(dup, unop(Iop_Dup16x8, load(Ity_I16, mkexpr(addr))));
         break;
      }
      case 0b10: {
         assign(addr, binop(Iop_Add64, getIReg64(rj),
                            mkU64(extend64(sImm << 2, 12))));
         assign(dup, unop(Iop_Dup32x4, load(Ity_I32, mkexpr(addr))));
         break;
      }
      case 0b11: {
         assign(addr, binop(Iop_Add64, getIReg64(rj),
                            mkU64(extend64(sImm << 3, 12))));
         assign(dup, binop(Iop_64HLtoV128, load(Ity_I64, mkexpr(addr)),
                           load(Ity_I64, mkexpr(addr))));
         break;
      }
      default:
                                               ...
                                               const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 25, 24)) {
      ...
      case 0b01:
         ...
         break;
      case 0b10:
         ok = gen_xvldrepl(dres, insn, archinfo, abiinfo);
         break;
      case 0b11:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 15)) {
      case 0b0000000:
         ok = gen_vldx(dres, insn, archinfo, abiinfo);
         break;
      case 0b0001000:
         ok = gen_vstx(dres, insn, archinfo, abiinfo);
         break;
      case 0b0010000:
         ok = gen_xvldx(dres, insn, archinfo, abiinfo);
         break;
      case 0b0011000:
         ok = gen_xvstx(dres, insn, archinfo, abiinfo);
         break;
      case 0b1000000:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b10000:
      case 0b10001:
         ok = gen_vabsd(dres, insn, archinfo, abiinfo);
         break;
      case 0b10010:
      case 0b10011:
      case 0b10100:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b00011:
      case 0b00100:
         ok = gen_vmul_vmuh(dres, insn, archinfo, abiinfo);
         break;
      case 0b01000:
      case 0b01001:
      case 0b01100:
      case 0b01101:
         ok = gen_vmulwevod_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b10000:
      case 0b10001:
         ok = gen_vmulwevod_x_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b10100:
      case 0b10101:
      ...
      case 0b11010:
      case 0b11011:
         ok = gen_vmaddwevod_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b11110:
      case 0b11111:
         ok = gen_vmaddwevod_x_x_x(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b10010:
      case 0b10011:
         ok = gen_vdiv_vmod(dres, insn, archinfo, abiinfo);
         break;
      case 0b10100:
      case 0b10101:
      case 0b10110:
         ok = gen_vshift(dres, insn, archinfo, abiinfo);
         break;
      case 0b10111:
         ok = gen_vrotr(dres, insn, archinfo, abiinfo);
         break;
      case 0b11000:
      case 0b11001:
         ok = gen_vsrlr_vsrar(dres, insn, archinfo, abiinfo);
         break;
      case 0b11010:
      case 0b11011:
      ...
      case 0b11100:
      case 0b11101:
         ok = gen_vsrlrn_vsrarn(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b10110:
         ...
         break;
      case 0b10111:
         ok = gen_vsigncov(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      case 0b11101:
         ok = gen_vshuf_hwd(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      case 0b0001:
         ok = gen_vbitseli_b(dres, insn, archinfo, abiinfo);
         break;
      case 0b0100:
      case 0b0101:
      case 0b0110:
                                               ...
                                               const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 25, 22)) {
      ...
      case 0b0100:
         ...
         break;
      case 0b0101:
         ok = disInstr_LOONGARCH64_WRK_01_1100_0101(dres, insn, archinfo, abiinfo);
         break;
      case 0b1010:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b11001:
      case 0b11010:
         ok = gen_xvaddw_xvsubw_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b11111:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b00101:
      case 0b00110:
         ok = gen_xvsadd_xvssub(dres, insn, archinfo, abiinfo);
         break;
      case 0b01010:
      case 0b01011:
      case 0b01100:
      ...
      case 0b10000:
      case 0b10001:
         ok = gen_xvabsd(dres, insn, archinfo, abiinfo);
         break;
      case 0b10010:
      case 0b10011:
      case 0b10100:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b00011:
      case 0b00100:
         ok = gen_xvmul_xvmuh(dres, insn, archinfo, abiinfo);
         break;
      case 0b01000:
      case 0b01001:
      case 0b01100:
      case 0b01101:
         ok = gen_xvmulwevod_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b10000:
      case 0b10001:
         ok = gen_xvmulwevod_x_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b10100:
      case 0b10101:
         ok = gen_xvmadd_xvmsub(dres, insn, archinfo, abiinfo);
         break;
      case 0b10110:
      case 0b10111:
      case 0b11010:
      case 0b11011:
         ok = gen_xvmaddwevod_x_x(dres, insn, archinfo, abiinfo);
         break;
      case 0b11110:
      case 0b11111:
         ok = gen_xvmaddwevod_x_x_x(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b10010:
      case 0b10011:
         ok = gen_xvdiv_xvmod(dres, insn, archinfo, abiinfo);
         break;
      case 0b10100:
      case 0b10101:
      case 0b10110:
         ok = gen_xvshift(dres, insn, archinfo, abiinfo);
         break;
      case 0b10111:
         ok = gen_xvrotr(dres, insn, archinfo, abiinfo);
         break;
      case 0b11000:
      case 0b11001:
         ok = gen_xvsrlr_xvsrar(dres, insn, archinfo, abiinfo);
         break;
      case 0b11010:
      case 0b11011:
      ...
      case 0b11100:
      case 0b11101:
         ok = gen_xvsrlrn_xvsrarn(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b10000:
         ...
         break;
      case 0b10001:
         ok = gen_xvreplve(dres, insn, archinfo, abiinfo);
         break;
      case 0b10011:
      case 0b10100:
      ...
      case 0b10110:
         ...
         break;
      case 0b10111:
         ok = gen_xvsigncov(dres, insn, archinfo, abiinfo);
         break;
      default:
         ok = False;
         break;
                                                          ...
                                                          const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 16, 12)) {
      case 0b00000:
      case 0b00001:
         ok = gen_xvclo_xvclz(dres, insn, archinfo, abiinfo);
         break;
      case 0b00010:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 17)) {
      ...
      case 0b00011:
      case 0b00100:
         ok = gen_xvcmpi_integer(dres, insn, archinfo, abiinfo);
         break;
      case 0b00101:
      case 0b00110:
      ...
      case 0b01010:
      case 0b01011:
         ok = gen_xvmaxi_xvmini(dres, insn, archinfo, abiinfo);
         break;
      case 0b01101:
                                                    ...
                                                    const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 21, 18)) {
      case 0b0001:
         ok = gen_xvbitseli_b(dres, insn, archinfo, abiinfo);
         break;
      case 0b0100:
      case 0b0101:
      case 0b0110:
                                               ...
                                               const VexAbiInfo*  abiinfo )
{
   ...
   switch (SLICE(insn, 25, 22)) {
      ...
      case 0b0001:
         ...
         break;
      case 0b0010:
         ok = disInstr_LOONGARCH64_WRK_01_1101_0010(dres, insn, archinfo, abiinfo);
         break;
      case 0b0011:
         ok = disInstr_LOONGARCH64_WRK_01_1101_0011(dres, insn, archinfo, abiinfo);
         break;
      case 0b0100:
